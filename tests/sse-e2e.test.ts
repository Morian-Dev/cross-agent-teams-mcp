...
describe('end-to-end SSE contract_event push', () => {
  ...
  it('subscribed client receives contract_event notification and unsubscribed does not', async () => {
    ...
    try {
      await clientA.callTool({ name: 'register_agent', arguments: { model: 'm', role: 'r' } })
      await clientB.callTool({ name: 'register_agent', arguments: { model: 'm', role: 'r' } })
      await clientC.callTool({ name: 'register_agent', arguments: { model: 'm', role: 'r' } })
