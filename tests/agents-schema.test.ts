...
describe('agents schema', () => {
  ...
  it('creates agents table with required columns and name is NOT NULL', () => {
    ...
    expect(names).toEqual([
      'agent_id','channel_session_id','delivery_kind','delivery_payload','last_processed_event_id','last_seen_at','model','name','registered_at','role','runtime_bound_at','runtime_tty','runtime_ui_pid','runtime_verification_mode','team','tmux_pane_id'
    ])
