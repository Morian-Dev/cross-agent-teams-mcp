# contract-subscriptions Specification

## Purpose

Let agents subscribe to contract changes within their team, receive real-time SSE pushes when online, and catch up via event polling after reconnect.
